...
GEOMETRY_DATA ={
    "Признаки равности прямоугольных треугольников": "Ещё в разработке;)",
    "Признаки параллельности прямых": "Ещё в разработке;)",
    "Признаки прямоугольного тругольника": "Ещё в разработке;)",
    "Признаки равенства треугольников": "Ещё в разработке;)"
}

PHYSICS_DATA ={
    "Введение в физику": "Ещё в разработке:)",
    "Скорость и ускорение": "Ещё в разработке:)",
    "Первый закон Ньютона": "Ещё в разработке:)",
    "Второй закон Ньютона": "Ещё в разработке:)"
}